...
public class BookingController {
	...
	*/
	...
	//Post : http://localhost:9090/bookin/makebook
		...
		@GetMapping("/find/{busId}/{jdate}")
		public List<Long> getBusbyseats(@PathVariable("busId") String busId,@PathVariable("jdate") String jdate)
		{
			List<Booking> booked= bookrepo.getBookedSeats(busId,jdate);
			System.out.println(booked);
			List<Long> bookedSeats = new ArrayList<Long>();
			for(Booking b:booked) {
				System.out.println(b.getJourneyDate());
				//DateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
				String date=b.getJourneyDate();
